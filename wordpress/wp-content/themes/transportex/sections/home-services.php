  ...
  <div class="container">
    <div class="row padding-bottom-80 text-left">
      <div class="ta-heading">
          ...
          <?php $transportex_service_subtitle = get_theme_mod('transportex_service_subtitle','laoreet ipsum eu laoreet. ugiignissimat Vivamus dignissim feugiat erat sit amet convallis.');
